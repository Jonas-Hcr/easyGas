...
export class QuilometragemService {
  ...
  */
  ...
  private endPoint : string = 'quilometragem';
  ...
  novo(quilometragem: any) {
    return this.http.post(env.apiUri + this.endPoint, quilometragem).toPromise();
  }
  ...
  atualizar(quilometragem: any) {
    return this.http.put(env.apiUri + this.endPoint, quilometragem).toPromise();
  }
